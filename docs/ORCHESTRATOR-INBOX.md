...
**更新于 2026-09-04 21:0x · P0 验收范围已收窄为 2026-06/07/08/09 四个月**

| # | 任务 | 在第几节 | 状态 |
|---|---|---|---|
| 1 | **T17 加并发**（今晚能否交付的唯一杠杆，串行 ~7h → 并发 8 ~50min） | `### 🚨 T17` | ✅ 完成（`fb96b2f`，功能验证通过，见 STATUS） |
| 2 | **T15-B 乳儿班补导** `--since 2026-07-27 --only 3`（空格不是等号），目标 7,244 | `### 🔧 T15-B 执行指令` | 🟡 进行中（后台跑，媒体量大较慢） |
| 3 | **T15-A** 09-02 / 09-03 补跑 | `### T15 ·` A 段 | ✅ 完成（3 条 life_event，见 STATUS） |
| 4 | **2026-07 整月** `--commit`（dry-run 已抽读通过） | `### 🎯 P0 验收范围` | ✅ 完成（46 条 life_event，0 家人，全部有标题，见 STATUS） |
| 5 | **2026-06 整月** | 同上 | ✅ 完成（32 条 life_event，0 家人，全部有标题，见 STATUS） |
| 6 | **2026-08 整月**（等 2 完成） | 同上 | ⛔ 阻塞于 2（T15-B 6,659/7,244，仍在跑） |
| 7 | **T16 视觉四条**（跑 DeepSeek 的空档做，不占同一资源） | `### T16 ·` | 🟡 进行中 |
| 8 | T15-D Windows `npm test`；T15-E 清孤儿 organizer_run | `### T15 ·` D/E 段 | 🔴 未开始 |

**P0 验收线**：2026-06、07、08、09 四个月完整（不是 21 个月）。详见 `### 🎯 P0 验收范围收窄`。
