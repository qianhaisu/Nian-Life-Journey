...
**其中 6 张根本不是他的照片**：是幼儿园的当日餐牌台卡（「好好吃饭吧」+ 日期 + 菜品）。
它们现在挂在 08-11、08-19、09-02 三段故事上，正式页面能看到。这一条单独提出来给复核人。
...
### 8. 09-09 就医候选：真正去医院是第二天

单独核过，写在 `round7-2026-09-11/candidate-09-09-doctor.md`，仓库外、未入库、不替代同日的「打开」。

逐条分开了**问过 / 同意 / 计划 / 真做了 / 结果**。要点：

- 09-09 只有**问和计划**（下午三点接他、市儿童医院、呼吸内科）。**那天并没有去成医院。**
  当晚真正发生的是「线上诊断了一个医生」「说不用住院」。
- **真的去是 09-10，而且去的是省儿保，不是计划里的市儿童医院。**
  「我们医院结束了」「省儿保说不用住院，用药就可以」「一去医院现在就哭」
  「医生说没事 吃了点药 今天没去学校」。
- 所以候选稿分两段。合成一段就会读成「那天带他去看了医生」，而那天没有。
