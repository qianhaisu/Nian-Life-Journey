...
export default async function EventDetailPage({ params }: { params: Promise<{ id: string }> }) {
	...
	return <article className="detail-page">
		...
		<div className="wide-wrap detail-lead"><div className="detail-lead-image"><Image src={heroMedia.src} alt={heroMedia.alt} fill priority sizes="(max-width: 700px) 100vw, 75vw" style={{ objectFit: "cover" }} /></div></div>
