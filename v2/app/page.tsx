...
export default async function HomePage() {
  ...
  return <div className="home-page">
    ...
    <MonthlyFocusGoals goals={focusGoals} snapshotMonth={snapshot?.month ?? “”} />
    <section className=”month-encounter wide-wrap”><div><span className=”section-mark”>这个月</span><p className=”serif”>”{snapshot?.summary ?? “”}”</p><Link className="text-link" href="/memory/2026/08">翻回八月 <span>↗</span></Link></div><aside><span className="section-mark">一年前的今天</span><h2 className="serif">一年前，他还不会走。</h2><p>不是每天提醒，只在有想再看一次的日子时出现。</p><Link href="/memory">去以前看看</Link></aside></section>
  </div>;
}
