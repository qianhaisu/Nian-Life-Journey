...
export const getMediaForDelivery = repository.getMediaForDelivery.bind(repository);
...
export const recordHumanStoryDecision = repository.recordHumanStoryDecision.bind(repository);
export const recordClaudeStoryDecision = repository.recordClaudeStoryDecision.bind(repository);
export const recordClaudeMediaDecision = repository.recordClaudeMediaDecision.bind(repository);
export const getMediaContentVersion = repository.getMediaContentVersion.bind(repository);
export const getStoryContentVersion = repository.getStoryContentVersion.bind(repository);
export const getStoryProtection = repository.getStoryProtection.bind(repository);
