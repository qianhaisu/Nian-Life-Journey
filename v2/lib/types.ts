...
export interface RawSource { id: string; profileId: string; sourceType: SourceType; contentTypes: ContentType[]; contributorId: string; capturedAt: string; importedAt: string; text?: string; mediaIds: string[]; sourceLabel: string; visibility: Visibility; status: RawSourceStatus; originalFilename?: string; provider?: string; providerExternalId?: string; metadata?: Record<string, unknown>; deletedAt?: string; relatedLifeEventId?: string; extractedMedicalFacts?: { hospital?: string; examinationType?: string; recordedAt?: string; facts: string[] }; }
