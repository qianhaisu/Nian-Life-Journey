...
say(`本批 ${rows.length} 条：批准 ${plan.approve.length}，留给人 ${plan.hold.length}${plan.tooMany ? "（数量超上限，整批留给人）" : ""}`);
...
ledger({ event: "approved", batchId, extracted: { created, updated }, approved: approved.ids, held: plan.hold, tooMany: plan.tooMany });
