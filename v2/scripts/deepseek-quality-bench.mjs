...
const PROBES = [
  ...
  { label: "neg:密码", expect: "unrelated", mode: "tight", like: "%密码%" },
  { label: "neg:玻璃", expect: "unrelated", mode: "tight", like: "%玻璃%" },
  ...
  { label: "neg:快递", expect: "unrelated", mode: "tight", like: "%快递%" },
  { label: "neg:打车", expect: "unrelated", mode: "tight", like: "%打车%" },
  { label: "neg:开会", expect: "unrelated", mode: "tight", like: "%开会%" },
  { label: "neg:冰箱", expect: "unrelated", mode: "tight", like: "%冰箱%" },
  { label: "neg:外卖", expect: "unrelated", mode: "tight", like: "%外卖%" },
  { label: "neg:商场", expect: "unrelated", mode: "tight", like: "%商场%" },
  { label: "neg:航班", expect: "unrelated", mode: "tight", like: "%航班%" },
  { label: "neg:物业", expect: "unrelated", mode: "tight", like: "%物业%" },
  ...
  { label: "pos:翻身", expect: "related", mode: "natural", like: "%翻身%" },
